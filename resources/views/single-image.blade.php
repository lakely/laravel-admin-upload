    ...
    <div class="{{$viewClass['field']}}">
        ...
        @if($column_val = old($column, $value))
            <div class="upload_add_btn Js_upload_warp">
                <img data-filename="{{$column_val}}" src="{{$column_val}}?x-oss-process=image/resize,m_fill,w_100,h_100">
                ...
                <input type="hidden" class="Js_upload_input" name="{{$column}}" value="{{$column_val}}">
            </div>
        @else
            <div class="upload_add_btn Js_upload_warp">
                <div class="upload_model" onclick="del_pic(this,false)">删除</div>
